...
> [!NOTE]
> Commands.NET is built on ns2.0 and 8.0, being available for use for virtually all versions from framework 4.6.1 onward. AOT compatibility is ensured from 8.0 onward. Read [here](https://learn.microsoft.com/nl-nl/dotnet/standard/net-standard?tabs=net-standard-2-0) for more details. 
