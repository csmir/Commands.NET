...
/// <summary>
///     A factory that creates a test execution sequence for a command.
/// </summary>
public interface ITestExecutionFactory
{
    ...
    /// </summary>
    /// <remarks>
    ///     When specifying the <paramref name="options"/> of this operation, the value of <see cref="ExecutionOptions.ExecuteAsynchronously"/> is ignored. 
    ...
    public Task StartTesting<TContext>(Command command, Func<string, TContext> callerCreation, ExecutionOptions? options = null)
