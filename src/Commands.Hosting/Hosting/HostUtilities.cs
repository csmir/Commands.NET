...
public static class HostUtilities
{
    ...
    /// <param name="builder"></param>
    /// <param name="configureAction">An action responsible for configuring a newly created instance of <see cref="ComponentProviderBuilder"/> in preparation for building an implementation of <see cref="IExecutionProvider"/> to execute commands with.</param>
    /// <returns>The same <see cref="IHostBuilder"/> for call-chaining.</returns>
