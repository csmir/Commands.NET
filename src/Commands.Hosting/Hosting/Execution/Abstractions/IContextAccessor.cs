...
/// </summary>
/// <typeparam name="TContext">The implementation of <see cref="ICallerContext"/> this accessor should return. If the current context is no implementation of <typeparamref name="TContext"/>, getting <see cref="Context"/> will throw an exception.</typeparam>
