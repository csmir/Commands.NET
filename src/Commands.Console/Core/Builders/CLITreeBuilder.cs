namespace Commands
{
    ...
    {
        /// <summary>
        ///     Adds a new <see cref="Delegate"/> based command to the list of <see cref="ComponentTreeBuilder.Components"/>. 
        /// </summary>
        /// <remarks>
        ...
        public static ComponentTreeBuilder AddCommand(this ComponentTreeBuilder builder, Delegate commandAction)
        {
        ...
        public static Task Run<T>(this ComponentTreeBuilder builder, CLIOptions<T> options)
        ...
        /// <returns>An asynchronous <see cref="Task"/> containing the state of the command execution.</returns>
        public static Task Run<T>(this ComponentTreeBuilder builder, T caller, string[] args)
            where T : ConsoleCallerContext
        {
