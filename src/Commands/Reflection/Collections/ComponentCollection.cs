...
namespace Commands.Reflection
{
    ...
    public abstract class ComponentCollection : ICollection<IComponent>, IEnumerable<IComponent>
    {
        ...
        /// <summary>
        ///     Gets if the collection has been marked as readonly when created by configuring <see cref="BuildConfiguration.SealModuleDefinitions"/>.
        /// </summary>
        ...
        /// <exception cref="ComponentException">Thrown when a collection is marked as read-only.</exception>
        ...
        /// <exception cref="ComponentException">Thrown when the collection is marked as read-only.</exception>
