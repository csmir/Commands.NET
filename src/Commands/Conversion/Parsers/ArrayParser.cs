namespace Commands.Conversion
{
    internal sealed class ArrayParser<T>(TypeParser underlyingConverter) : TypeParser<T>, ICollectionConverter
    {
        ...
        public override async Task<ConvertResult> Parse(ICallerContext consumer, IArgument argument, object? value, IServiceProvider services, CancellationToken cancellationToken)
        {
