...
{
    /// <summary>
    ///     A builder class used to create a new instance of <see cref="ComponentConfiguration"/>.
    /// </summary>
    public class ComponentConfigurationBuilder
    {
        ...
        public ComponentConfigurationBuilder AddTypeConverter<TConvertable>(Func<CallerContext, IArgument, object?, IServiceProvider, ConvertResult> convertAction)
        {
        ...
        /// <param name="convertAction">The action that is responsible for the conversion process.</param>
        /// <returns>The same <see cref="ComponentConfigurationBuilder"/> for call-chaining.</returns>
        public ComponentConfigurationBuilder AddTypeConverter<TConvertable>(Func<CallerContext, IArgument, object?, IServiceProvider, ValueTask<ConvertResult>> convertAction)
        {
            if (convertAction == null)
                throw new ArgumentNullException(nameof(convertAction));
        ...
        /// <returns>The same <see cref="ComponentConfigurationBuilder"/> for call-chaining.</returns>
        public ComponentConfigurationBuilder AddTypeConverter<TConverter>(TConverter converter)
        ...
        /// <returns>The same <see cref="ComponentConfigurationBuilder"/> for call-chaining.</returns>
        public ComponentConfigurationBuilder WithTypeConverters(params IEnumerable<TypeConverter> converters)
        {
        ...
        /// <returns>The same <see cref="ComponentConfigurationBuilder"/> for call-chaining.</returns>
        public ComponentConfigurationBuilder AddTypeConverters(params IEnumerable<TypeConverter> converters)
        {
        ...
        /// <summary>
        ///     Builds the current <see cref="ComponentConfigurationBuilder"/> into a new instance of <see cref="ComponentConfiguration"/>.
        /// </summary>
