...
///         <item>When set on a type that implements a <see cref="ITypeParser"/>, either custom or default, the remaining entries in the query will be joined into a single string, converted, and passed to the argument.</item>
