namespace Commands
{
        ...
        : Exception(message, innerException)
    {
        ...
        const string COLLECTION_NOT_SUPPORTED = $"The element type of an array is not supported for conversion. Replace, or create a parser to support this type: '{{0}}'";
        ...
        internal static BuildException ParserNotSupported(Type type)
