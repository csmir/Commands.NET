...
public interface IComponentTree : IComponentCollection
{
    ...
    /// <returns>An awaitable <see cref="ValueTask"/> hosting the state of execution. This task should be awaited, even if <see cref="CommandOptions.AsynchronousExecution"/> is set to <see langword="true"/>.</returns>
