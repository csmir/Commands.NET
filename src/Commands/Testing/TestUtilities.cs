...
{
    /// <summary>
    ///     Tests the target command using the provided <paramref name="callerCreation"/> function to create the context for each individual execution.
    /// </summary>
    /// <remarks>
    ...
    public static async ValueTask<IEnumerable<TestResult>> Test<TContext>(this Command command, Func<string, TContext> callerCreation, ExecutionOptions? options = null)
