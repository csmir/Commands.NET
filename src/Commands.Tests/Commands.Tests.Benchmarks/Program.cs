...
{
    public override Arguments Arguments { get; } = Arguments.FromString(input);
...
{
    private static readonly Arguments _args = Arguments.FromString("command");
