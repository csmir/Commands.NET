...
var components = new ComponentTree()
{
    ...
    new Command(async (ConsoleCallerContext context, int timeout) =>
    {
...
var provider = new ComponentProvider(components, new HandlerDelegate<ConsoleCallerContext>((c, e, s) => c.Respond(e)));
